...
int main()
{
    vector<int> v; //v is the oject that is created
    ...
    vector<int>::iterator itr=v.begin(); //iterator is the class. itr is the object of iterator. begin will start the iterator at beginning of the collection. begin method is available for all containers.
